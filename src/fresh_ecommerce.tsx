...
const products = [
  ...
  },
  {
    ...
    category: "Vegetables",
    image: "🥬",
    description: "Tender organic baby spinach",
    stock: 40,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    category: "Fruits",
    image: "🍎",
    description: "Crispy Honeycrisp apples",
    stock: 55,
  },
  {
    id: 11,
          ...
          <div style={styles.headerContent}>
            ...
            <nav style={styles.nav}>
              ...
              <button
                style={{
                  ...styles.navBtn,
                  ...(currentPage === "shop" && styles.navBtnActive),
                }}
              ...
              <button style={{ ...styles.navBtn, ...styles.contactBtn }}>
                Contact
              </button>
            </nav>
          ...
          <section style={styles.hero}>
            <div style={styles.container}>
              ...
              <p style={styles.heroText}>
                Premium organic produce picked at peak freshness and delivered
                within 24 hours
              </p>
              ...
              <div style={styles.featuresGrid}>
                <div style={styles.featureCard}>
                  ...
                  <p style={styles.featureText}>
                    Certified organic produce from local farms
                  </p>
                </div>
                <div style={styles.featureCard}>
                  ...
                  <p style={styles.featureText}>
                    Fresh from farm to table in one day
                  </p>
                </div>
                <div style={styles.featureCard}>
          ...
          <section style={styles.featuredSection}>
            <div style={styles.container}>
              ...
              <p style={styles.sectionSubtitle}>
                Seasonal favorites picked just for you
              </p>
          ...
          <section style={styles.ctaSection}>
            <div style={styles.container}>
              ...
              <p style={{ fontSize: "1.25rem", marginBottom: "2rem" }}>
                Join thousands of happy customers enjoying fresh, organic
                produce
              </p>
              <button
                style={styles.ctaBtn}
              ...
              {filteredProducts.map((product) => (
                <div key={product.id} style={styles.productCardShop}>
                  <div style={styles.productHeader}>
                    ...
                    >
                      <Heart
                        size={24}
                        color={
                          favorites.includes(product.id) ? "#ef4444" : "#9ca3af"
                        }
                        fill={
                  ...
                  <div style={styles.productInfo}>
                    <div>
                      <span style={styles.productPriceLarge}>
                        ${product.price}
                      </span>
          ...
          <div style={styles.container}>
            ...
            {orderPlaced ? (
              <div style={styles.orderSuccess}>
                ...
                >
                  Your fresh produce will arrive within 24 hours
                </p>
          ...
          <div style={styles.footerGrid}>
            <div>
              ...
              <p style={styles.footerText}>
                Delivering farm-fresh organic produce to your doorstep since
                2020.
              </p>
            </div>
            <div>
